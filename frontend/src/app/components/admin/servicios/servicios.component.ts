...
import { VerServiciosComponent } from './ver/ver.component'
...
export class ServiciosComponent implements OnInit {
    ...
    displayedColumns: string[] = [ 'nombre_servicio', 'precio', 'descripcion', 'estado','options'];
    usuarios:any;
    constructor(
    ...
    ver(element:any){
        const dialogRef = this.dialog.open(VerServiciosComponent, {
            width:'50%',
            data:element
        });
